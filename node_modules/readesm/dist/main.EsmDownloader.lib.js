...
/***/ "./src/DataTypes/VuCompanyLocksRecord.ts":
/*!***********************************************!*\
  !*** ./src/DataTypes/VuCompanyLocksRecord.ts ***!
  \***********************************************/
/*! no static exports found */
...
var Timespan_1 = __webpack_require__(/*! DataTypes/Timespan */ "./src/DataTypes/Timespan.ts");
var FullCardNumber_1 = __webpack_require__(/*! DataTypes/FullCardNumber */ "./src/DataTypes/FullCardNumber.ts");
var VuCompanyLocksRecord = /** @class */ (function (_super) {
    __extends(VuCompanyLocksRecord, _super);
    function VuCompanyLocksRecord(data) {
        var _this = _super.call(this, data) || this;
        _this.lockTime = new Timespan_1.default(data.slice(0));
        _this.companyName = DataReader_1.default.readCodePageString(data, 8, 36).toString();
        _this.companyAddress = DataReader_1.default.readCodePageString(data, 44, 36).toString();
        _this.companyCardNumber = new FullCardNumber_1.default(data.slice(80));
        return _this;
    }
    VuCompanyLocksRecord.prototype.className = function () {
        return "VuCompanyLocksRecord";
    };
    VuCompanyLocksRecord.prototype.title = function () {
        return "";
    };
    VuCompanyLocksRecord.prototype.size = function () {
        return 98;
    };
    VuCompanyLocksRecord.prototype.toString = function () {
        var qs = new QString_1.default('VuCompanyLocksRecord');
        return qs.toString();
    };
    VuCompanyLocksRecord.prototype.printOn = function (report) {
        report.tagValuePair(Translation_1.tr("lockTime"), this.lockTime.toString());
        report.tagValuePair(Translation_1.tr("companyName"), this.companyName);
        report.tagValuePair(Translation_1.tr("companyAddress"), this.companyAddress);
        report.writeBlock(this.companyCardNumber, Translation_1.tr("companyCardNumber"));
    };
    VuCompanyLocksRecord.BLOCK_TYPE = 0;
    VuCompanyLocksRecord.staticSize = 98;
    return VuCompanyLocksRecord;
}(DataType_1.default));
exports.default = VuCompanyLocksRecord;


/***/ }),

/***/ "./src/DataTypes/VuControlActivityRecord.ts":
/*!**************************************************!*\
  !*** ./src/DataTypes/VuControlActivityRecord.ts ***!
  \**************************************************/
/*! no static exports found */
...
var Timespan_1 = __webpack_require__(/*! DataTypes/Timespan */ "./src/DataTypes/Timespan.ts");
var FullCardNumber_1 = __webpack_require__(/*! DataTypes/FullCardNumber */ "./src/DataTypes/FullCardNumber.ts");
var VuControlActivityRecord = /** @class */ (function (_super) {
    __extends(VuControlActivityRecord, _super);
    function VuControlActivityRecord(data) {
        var _this = _super.call(this, data) || this;
        _this.controlType = DataReader_1.default.readUint8(data, 0);
        _this.controlTime = new TimeReal_1.default(data.slice(1));
        _this.controlCardNumber = new FullCardNumber_1.default(data.slice(5));
        _this.downloadPeriod = new Timespan_1.default(data.slice(23));
        return _this;
    }
    VuControlActivityRecord.prototype.className = function () {
        return "VuControlActivityRecord";
    };
    VuControlActivityRecord.prototype.title = function () {
        return "";
    };
    VuControlActivityRecord.prototype.size = function () {
        return 31;
    };
    VuControlActivityRecord.prototype.toString = function () {
        var qs = new QString_1.default('VuControlActivityRecord');
        return qs.toString();
    };
    VuControlActivityRecord.prototype.printOn = function (report) {
        report.tagValuePair(Translation_1.tr("controlType"), FormatStrings_1.default.controlType(this.controlType));
        report.tagValuePair(Translation_1.tr("controlTime"), this.controlTime.toString());
        report.writeBlock(this.controlCardNumber, Translation_1.tr("controlCardNumber"));
        report.tagValuePair(Translation_1.tr("downloadPeriod"), this.downloadPeriod.toString());
    };
    VuControlActivityRecord.BLOCK_TYPE = 0;
    VuControlActivityRecord.staticSize = 31;
    return VuControlActivityRecord;
}(DataType_1.default));
exports.default = VuControlActivityRecord;


/***/ }),

/***/ "./src/DataTypes/VuDetailedSpeedBlock.ts":
/*!***********************************************!*\
  !*** ./src/DataTypes/VuDetailedSpeedBlock.ts ***!
  \***********************************************/
/*! no static exports found */
...
var Translation_1 = __webpack_require__(/*! utils/Translation */ "./src/utils/Translation.ts");
var TimeReal_1 = __webpack_require__(/*! DataTypes/TimeReal */ "./src/DataTypes/TimeReal.ts");
var VuDetailedSpeedBlock = /** @class */ (function (_super) {
    __extends(VuDetailedSpeedBlock, _super);
    function VuDetailedSpeedBlock(data) {
        var _this = _super.call(this, data) || this;
        _this.speedBlockBeginDate = new TimeReal_1.default(data.slice(0));
        _this.speedsPerSecond = DataReader_1.default.readRawData(data, 4, 60);
        return _this;
    }
    VuDetailedSpeedBlock.prototype.className = function () {
        return "VuDetailedSpeedBlock";
    };
    VuDetailedSpeedBlock.prototype.title = function () {
        return "Speed";
    };
    VuDetailedSpeedBlock.prototype.size = function () {
        return 64;
    };
    VuDetailedSpeedBlock.prototype.toString = function () {
        var qs = new QString_1.default('VuDetailedSpeedBlock');
        return qs.toString();
    };
    VuDetailedSpeedBlock.prototype.printOn = function (report) {
        report.tagValuePair(Translation_1.tr("speedBlockBeginDate"), this.speedBlockBeginDate.toString());
        report.tagValuePair(Translation_1.tr("speedsPerSecond"), this.speedsPerSecond.toString());
    };
    VuDetailedSpeedBlock.BLOCK_TYPE = 0;
    VuDetailedSpeedBlock.staticSize = 64;
    return VuDetailedSpeedBlock;
}(DataType_1.default));
exports.default = VuDetailedSpeedBlock;
...
var VuActivities = /** @class */ (function (_super) {
    ...
    function VuActivities(data) {
        var _this = _super.call(this, data) || this;
        _this.timeReal = new TimeReal_1.default(data.slice(2));
        _this.odometerValueMidnight = DataReader_1.default.readUint24(data, 6);
        _this.nextBlock = _this.getNext(data);
        return _this;
    }
    ...
    VuActivities.prototype.getNext = function (data) {
        var _data = new Uint8Array(data);
        var i = 0;
        while (i != -1) {
            i = _data.indexOf(0x76, i + 1);
            if (_data[i + 1] == 0x2 || _data[i + 1] == 0x3)
                return i;
        }
    };
...
var VuBlock = /** @class */ (function (_super) {
    ...
    VuBlock.prototype.getNext = function (data, next) {
        var _data = new Uint8Array(data);
        var i = 0;
        while (i != -1) {
            i = _data.indexOf(0x76, i + 1);
...
var QString_1 = __webpack_require__(/*! utils/QString */ "./src/utils/QString.ts");
var VuBlock_1 = __webpack_require__(/*! VuBlocks/VuBlock */ "./src/VuBlocks/VuBlock.ts");
var VuDetailedSpeedBlock_1 = __webpack_require__(/*! DataTypes/VuDetailedSpeedBlock */ "./src/DataTypes/VuDetailedSpeedBlock.ts");
var VuDetailedSpeedData = /** @class */ (function (_super) {
    __extends(VuDetailedSpeedData, _super);
    function VuDetailedSpeedData(data) {
        var _this = _super.call(this, data) || this;
        _this.vuDetailedSpeedBlock = DataReader_1.default.readSubblocksByCount(VuDetailedSpeedBlock_1.default, data.slice(4), 0, (DataReader_1.default.readUint8(data, 2)));
        _this.nextBlock = _this.getNext(data, 0x5);
        return _this;
    }
...
var VuEventsFaults = /** @class */ (function (_super) {
    ...
    function VuEventsFaults(data) {
        var _this = _super.call(this, data) || this;
        _this.vuFaultRecord = DataReader_1.default.readSubblocksByCount(VuFaultRecord_1.default, data.slice(3), 0, (DataReader_1.default.readUint8(data, 2)));
        _this.vuEventRecord = DataReader_1.default.readSubblocksByCount(VuEventRecord_1.default, data.slice(3 + _this.vuFaultRecord.size() + 1), 0, (DataReader_1.default.readUint8(data, 3 + _this.vuFaultRecord.size())));
        var recSize = _this.vuFaultRecord.size() + _this.vuEventRecord.size();
        _this.lastOverspeedControlTime = new TimeReal_1.default(data.slice(4 + recSize));
        _this.firstOverspeedSince = new TimeReal_1.default(data.slice(8 + recSize));
        _this.numberOfOverspeedSince = DataReader_1.default.readUint8(data, 12 + recSize);
        _this.vuOverspeedingEventRecord = DataReader_1.default.readSubblocksByCount(VuOverspeedingEventRecord_1.default, data.slice(13 + recSize + 1), 0, (DataReader_1.default.readUint8(data, 13 + recSize)));
        _this.vuTimeAdjustmentRecord = DataReader_1.default.readSubblocksByCount(VuTimeAdjustmentRecord_1.default, data.slice(14 + recSize + 1), 0, (DataReader_1.default.readUint8(data, 14 + recSize)));
        _this.nextBlock = _this.getNext(data, 0x4);
        return _this;
    }
...
var VehicleRegistration_1 = __webpack_require__(/*! DataTypes/VehicleRegistration */ "./src/DataTypes/VehicleRegistration.ts");
var FullCardNumber_1 = __webpack_require__(/*! DataTypes/FullCardNumber */ "./src/DataTypes/FullCardNumber.ts");
var VuControlActivityRecord_1 = __webpack_require__(/*! DataTypes/VuControlActivityRecord */ "./src/DataTypes/VuControlActivityRecord.ts");
var VuCompanyLocksRecord_1 = __webpack_require__(/*! DataTypes/VuCompanyLocksRecord */ "./src/DataTypes/VuCompanyLocksRecord.ts");
var TimeReal_1 = __webpack_require__(/*! DataTypes/TimeReal */ "./src/DataTypes/TimeReal.ts");
var EncryptedCertificate_1 = __webpack_require__(/*! DataTypes/EncryptedCertificate */ "./src/DataTypes/EncryptedCertificate.ts");
var VuOverview = /** @class */ (function (_super) {
    ...
    function VuOverview(data) {
        var _this = _super.call(this, data) || this;
        _this.memberStateCertificate = new EncryptedCertificate_1.default(data.slice(2));
        _this.vuCertificate = new EncryptedCertificate_1.default(data.slice(196));
        _this.vehicleIdentificationNumber = DataReader_1.default.readString(data, 390, 17).toString();
        _this.vehicleRegistrationIdentification = new VehicleRegistration_1.default(data.slice(407));
        _this.currentDateTime = new TimeReal_1.default(data.slice(422));
        _this.vuDownloadablePeriod = new Timespan_1.default(data.slice(426));
        _this.CardSlotsStatus = DataReader_1.default.readUint8(data, 434);
        _this.downloadingTime = new TimeReal_1.default(data.slice(435));
        _this.cardNumber = new FullCardNumber_1.default(data.slice(439));
        _this.companyOrWorkshopName = DataReader_1.default.readCodePageString(data, 457, 36).toString();
        var pos = VuOverview.START_OF_BLOCKS;
        _this.vuCompanyLocksRecord = DataReader_1.default.readSubblocksByCount(VuCompanyLocksRecord_1.default, data.slice(pos + 1), 0, (DataReader_1.default.readUint8(data, pos)));
        pos += _this.vuCompanyLocksRecord.size() + 1;
        _this.vuControlActivityRecord = DataReader_1.default.readSubblocksByCount(VuControlActivityRecord_1.default, data.slice(pos + 1), 0, (DataReader_1.default.readUint8(data, pos)));
        return _this;
    }
    ...
    VuOverview.START_OF_BLOCKS = 493;
    VuOverview.SIGNATURE_TREP1 = 128;
    return VuOverview;
}(VuBlock_1.default));
...
var VuTechnical = /** @class */ (function (_super) {
    ...
    function VuTechnical(data) {
        var _this = _super.call(this, data) || this;
        _this.vuManufacturerName = DataReader_1.default.readCodePageString(data, 2, 36).toString();
        _this.vuManufacturerAddress = DataReader_1.default.readCodePageString(data, 38, 36).toString();
        _this.vuPartNumber = DataReader_1.default.readString(data, 74, 16).toString();
        _this.vuSerialNumber = new ExtendedSerialNumber_1.default(data.slice(90));
        _this.vuSoftwareVersion = DataReader_1.default.readString(data, 98, 4).toString();
        _this.vuSoftInstallationDate = new TimeReal_1.default(data.slice(102));
        _this.vuManufacturingDate = new TimeReal_1.default(data.slice(106));
        _this.vuApprovalNumber = DataReader_1.default.readString(data, 110, 8).toString();
        _this.sensorSerialNumber = new ExtendedSerialNumber_1.default(data.slice(118));
        _this.sensorApprovalNumber = DataReader_1.default.readString(data, 126, 8).toString();
        _this.sensorPairingDateFirst = new TimeReal_1.default(data.slice(134));
        _this.vuCalibrationRecord = DataReader_1.default.readSubblocksByCount(VuCalibrationRecord_1.default, data.slice(138 + 1), 0, (DataReader_1.default.readUint8(data, 138)));
        return _this;
    }
...
function blockFactory(data, pos) {
    if (DataReader_1.default.readUint8(data, pos) == 0x76) {
...
function vuBlockFactory(data, pos) {
    ...
    data = data.slice(pos);
    if (data.byteLength < 2 || DataReader_1.default.readUint8(data, 0) != 0x76) {
